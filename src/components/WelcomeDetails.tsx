            ...
            <div className='w-80'>
                ...
                <ul className='space-y-4 list-none cursor-pointer'>
                    <li className='flex items-center space-x-3 border-b border-gray-300 text-red-500 pb-2 animate-pulse'>
                        ...
                        <Link href="#" className='text-sm'>Undergraduate Portal</Link>
                    </li>
                    ...
                    <Link href="/login" className='flex items-center space-x-3 border-b border-gray-300 hover:text-blue-500 pb-2'>
                        <PlayCircle className='w-4 h-4' />
