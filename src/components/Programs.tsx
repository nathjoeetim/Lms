...
const Programs = (props: Props) => {
    ...
    {/* <div className='flex justify-evenly items-center gap-3 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
        <div className='bg-slate-200 w-80 h-50 p-4 text-gray-500 shadow-md'>
